...
macro(cmmm_check_and_include_file CMMM_FILENAME)
  ...
  if(NOT EXISTS "${CMMM_FILE_DESTINATION}" OR CMMM_ALWAYS_DOWNLOAD)
    cmmm_download(URL "${CMMM_URL}/${CMMM_VERSION}/${CMMM_FILENAME}" DESTINATION "${CMMM_FILE_DESTINATION}")
  endif()
...
function(cmmm_check_updates)
  ...
  set(CMMM_LATEST_VERSION_URL "${CMMM_URL}/${CMMM_VERSION}/LatestVersion.cmake")
  ...
  if(CMMM_RC EQUAL 0)
    ...
    if(${CMMM_VERSION} VERSION_LESS ${CMMM_LATEST_VERSION})
      if(NOT ${CMMM_IGNORE_NEW_VERSION})
        set(CMMM_CHANGELOG_URL  "${CMMM_URL}/${CMMM_VERSION}/Changelog.cmake")
