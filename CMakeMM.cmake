function(cmcm_module ARG_NAME)
  ...
  file(WRITE "${CMMM_INSTALL_DESTINATION}/${ARG_NAME}" "cmmm_include_module([[${ARG_NAME}]] [[${ARG_REMOTE}]] [[${ARG_LOCAL}]] [[${ARG_VERSION}]] [[${ARG_ALSO}]])\n")
endfunction()

macro(cmmm_include_module MODULE_NAME remote local version also)
  ...
  set(CMMM_WHENCE_STRING "${CMMM_URL_MODULES}::${remote}${local}.${version}")
  ...
  if(DOWNLOAD_MODULE)
    ...
    if(remote)
      ...
      set(URL "${CMMM_URL_MODULES}/${local}")
    endif()
    message("${BoldMagenta}-- [CMakeCM] Downloading new module ${MODULE_NAME} --${Reset}")
    file(DOWNLOAD "${URL}" "${CMMM_RESOLVED}" STATUS DOWNLOAD_STATUS)
    list(GET DOWNLOAD_STATUS 0 CODE)
    list(GET DOWNLOAD_STATUS 1 MESSAGE)
    if(CODE)
      message("${BoldRed}!! [CMakeCM] Error while downloading file from '${URL}' to '${CMMM_RESOLVED}' [${CODE}]: ${MESSAGE} !!${Reset}")
      message(FATAL_ERROR)
    endif()
